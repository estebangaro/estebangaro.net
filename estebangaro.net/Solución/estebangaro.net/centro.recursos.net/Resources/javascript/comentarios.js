            ...
            function muestraPopUpGComentarios(configuracion) {
                mostrarPopupG({
                    ...
                    Contenido: configuracion.Contenido.length == undefined ?
                        $('<span/>').text(configuracion.Contenido) : configuracion.Contenido,
            ...
            function btnPublicarManejadorClicOK(btnPublicar, datosPopUp) {
                ...
                publicaComentario({
                    ...
                    Contenido: accion == "Publicar" ?
                        $('#comentarioPublicar .contenido > textarea').val() : btnPublicar.parent().find('textarea').val(),
                    Boton: btnPublicar,
            ...
            function sonComentariosAnidados(nivel, ctdrComentario) {
                if (nivel > 0) {
                    ajustaLblResponder(ctdrComentario.parent()
            ...
            function cargaComentarios(tipo = "recientes") {
                mostrarEsperaPopUpG(true, '.mostrarMasComentarios');
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {
                        id: window.location.pathname.toLowerCase().substring(1).replace(/\//g, "-"),
                        tipo: tipo,
                        ultimoantiguo: tipo != "recientes" ?
                            obtenIdComentario('MostrarMas') : 0
                    },
                    success: function(data) {
                        mostrarEsperaPopUpG(false, '.mostrarMasComentarios');
